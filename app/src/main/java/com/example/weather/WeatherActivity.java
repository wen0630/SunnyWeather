...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String bingPicUrl = sharedPreferences.getString("imgUrl",null);
        if(bingPicUrl != null)
        {
        ...
        HttpUtil.sendOkHttpRequest(url, new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Glide.with(WeatherActivity.this).load(bingImgUrl).into(bingPicImg);
                    }
                });
            }
        });
    ...
    public void requestWeather(String weatherId) {
        loadBingImg();
        String url = "http://guolin.tech/api/weather?cityid="+weatherId+"+&key=f4bfb31503ba4438869970e496e60a07";
        HttpUtil.sendOkHttpRequest(url, new Callback() {
            @Override
            public void onFailure(@NotNull Call call, @NotNull IOException e) {
                e.printStackTrace();
